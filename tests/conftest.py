...
_INDEX_RST_BADGE_CODECOV = '''.. image:: https://img.shields.io/codecov/c/gh/hendrikdutoit/sqldbwrpr
    :alt: CodeCov
    :target: https://app.codecov.io/gh/hendrikdutoit/sqldbwrpr

'''
_INDEX_RST_BADGE_GITHUB_CI = '''.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/sqldbwrpr/CI
    :alt: GitHub Actions - CI
    :target: https://github.com/hendrikdutoit/sqldbwrpr/actions/workflows/ci.yaml

'''
_INDEX_RST_BADGE_GITHUB_HITS = '''.. image:: https://img.shields.io/github/search/hendrikdutoit/sqldbwrpr/GitHub hit
    :alt: GitHub Searches

'''
_INDEX_RST_BADGE_GITHUB_LICENSE = '''.. image:: https://img.shields.io/github/license/hendrikdutoit/sqldbwrpr
    :alt: License

'''
_INDEX_RST_BADGE_GITHUB_ISSUES = '''.. image:: https://img.shields.io/github/issues-raw/hendrikdutoit/sqldbwrpr
    :alt: GitHub issues

'''
_INDEX_RST_BADGE_GITHUB_PRE_COMMIT = '''.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/sqldbwrpr/Pre-Commit
    :alt: GitHub Actions - Pre-Commit
    :target: https://github.com/hendrikdutoit/sqldbwrpr/actions/workflows/pre-commit.yaml

'''
_INDEX_RST_BADGE_GITHUB_RELEASE = '''.. image:: https://img.shields.io/github/v/release/hendrikdutoit/sqldbwrpr
    :alt: GitHub release (latest by date)

'''
_INDEX_RST_BADGE_PYPI_VERSION = '''.. image:: https://img.shields.io/testpypi/v/sqldbwrpr
    :alt: PyPi

'''
_INDEX_RST_BADGE_PYPI_DL = '''.. image:: https://img.shields.io/pypi/dm/sqldbwrpr
    :alt: PyPI - Downloads

'''
_INDEX_RST_BADGE_PYPI_STATUS = '''.. image:: https://img.shields.io/pypi/status/sqldbwrpr
    :alt: PyPI - Status

'''
_INDEX_RST_BADGE_PYPI_WHEEL = '''.. image:: https://img.shields.io/pypi/wheel/sqldbwrpr
    :alt: PyPI - Wheel

'''
_INDEX_RST_BADGE_PYVERSIONS = '''.. image:: https://img.shields.io/pypi/pyversions/sqldbwrpr
...
.. image:: https://img.shields.io/pypi/status/sqldbwrpr
    :alt: PyPI - Status

.. image:: https://img.shields.io/pypi/wheel/sqldbwrpr
    :alt: PyPI - Wheel

.. image:: https://img.shields.io/pypi/pyversions/sqldbwrpr
    :alt: PyPI - Python Version

.. image:: https://img.shields.io/github/v/release/hendrikdutoit/sqldbwrpr
    :alt: GitHub release (latest by date)

.. image:: https://img.shields.io/github/license/hendrikdutoit/sqldbwrpr
    :alt: License

.. image:: https://img.shields.io/github/issues-raw/hendrikdutoit/sqldbwrpr
    :alt: GitHub issues

.. image:: https://img.shields.io/pypi/dm/sqldbwrpr
    :alt: PyPI - Downloads

.. image:: https://img.shields.io/github/search/hendrikdutoit/sqldbwrpr/GitHub hit
    :alt: GitHub Searches

.. image:: https://img.shields.io/codecov/c/gh/hendrikdutoit/sqldbwrpr
    :alt: CodeCov
    :target: https://app.codecov.io/gh/hendrikdutoit/sqldbwrpr

.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/sqldbwrpr/Pre-Commit
    :alt: GitHub Actions - Pre-Commit
    :target: https://github.com/hendrikdutoit/sqldbwrpr/actions/workflows/pre-commit.yaml

.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/sqldbwrpr/CI
    :alt: GitHub Actions - CI
    :target: https://github.com/hendrikdutoit/sqldbwrpr/actions/workflows/ci.yaml

.. image:: https://img.shields.io/testpypi/v/sqldbwrpr
    :alt: PyPi
